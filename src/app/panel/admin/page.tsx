...
export default function AdminPage() {
  ...
  const [accionesUsuario, setAccionesUsuario] = useState<AccionUsuario[]>([]);
  const [accionesRecep, setAccionesRecep] = useState<AccionUsuario[]>([]);
  ...
  // Guardia de rol en cliente: si no es Administrador, redirige al panel
  useEffect(() => {
  ...
  // Se eliminan secciones de acciones; sólo tabla con acciones por fila
